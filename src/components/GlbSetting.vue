<template>
    <el-drawer :visible="drawer"
        ...
        <div class="box">
            <div class="box-item">
                <span>左侧导航背景颜色</span>
                <el-color-picker v-model="asideColor" size="mini" float="right" pickerC
                                 @change="asideChange"></el-color-picker><!--pickerC:颜色选择器的上调属性 开关可不添加这个属性-->
            </div>
            <div class="box-item">
                <span>左侧导航文字颜色</span>
                <el-color-picker v-model="aTextColor" size="mini" float="right" pickerC
                                 @change="textChange"></el-color-picker>
            </div>
            <div class="box-item">
                <span>左侧导航文字选中颜色</span>
                <el-color-picker v-model="aActiveColor" size="mini" float="right" pickerC
                                 @change="activeChange"></el-color-picker>
            </div>
            <div class="box-item">
                <span>头部背景颜色</span>
                <el-color-picker v-model="headerBColor" size="mini" float="right" pickerC
                                 @change="headColor"></el-color-picker>
            </div>
            <div class="box-item">
                <span>头部颜色</span>
                <el-color-picker v-model="headerColor" size="mini" float="right" pickerC
                                 @change="hColor"></el-color-picker>
            </div>
            <div class="box-item">
                <span>是否只打开一个菜单</span>
                <el-switch v-model="doubleOpen" active-color="#409EFF" inactive-color="#909399" float="right"
                           @change="valueChange"></el-switch>
            </div>
        </div>
    </el-drawer>
</template>
