            ...
            <el-col :span="24" style="padding-bottom: 0;">
                <el-form :inline="true" :model="filters">
                    <el-form-item prop="name">
                        <el-input v-model="filters.name" placeholder="角色" prefix-icon="el-icon-search" @keyup.enter.native="btnSearch()"></el-input>
                    </el-form-item>
        ...
        <el-col :span="11" style="padding-left: 10px;">
            ...
            <el-col :span="24" style="padding-bottom: 0;">
                <el-form :inline="true" :model="filtersAuth">
                    <el-form-item prop="name">
                        <el-input v-model="filtersAuth.name" placeholder="权限" prefix-icon="el-icon-search" @keyup.enter.native="btnAuthSearch()"></el-input>
                    </el-form-item>
                    <el-form-item prop="effective" style="margin-right: 10px">
                        <el-select v-model="filtersAuth.effective" placeholder="请选择" style="width: 100px" @change="typeAuthChange">
                            <el-option
                                    v-for="item in options"
                                    :key="item.value"
                                    :label="item.label"
                    ...
                    <el-dropdown split-button type="primary" @click="btnAuthSearch" trigger="click"
                                 style="margin-right: 10px">
                        搜索
                        <el-dropdown-menu slot="dropdown" trigger="click">
                    ...
                    <el-dropdown split-button type="primary" @click="btnAuthNew" trigger="click"
                                 style="margin-right: 10px">
                        新增
                        <el-dropdown-menu slot="dropdown" trigger="click">
    ...
    export default {
        ...
        methods: {
            ...
            btnSearch() {
                ...
                this.post_url(url, param, "查询角色失败！", null).then(function (res) {
            ...
            btnAuthSearch() {
                ...
                this.post_url(url, param, "查询权限失败！", null).then(function (res) {
            ...
            addSubmit() {
                ...
                this.post_url(url, param, "新增角色失败！", null).then(function (res) {
            ...
            addAuthSubmit() {
                ...
                this.post_url(url, param, "新增权限失败！", null).then(function (res) {
            ...
            editSubmit() {
                ...
                this.post_url(url, param, "修改角色失败！", null).then(function (res) {
            ...
            editAuthSubmit() {
                ...
                this.post_url(url, param, "修改权限失败！", null).then(function (res) {
            ...
            updateRoleAuthId() {
                this.$confirm('确认提交吗？', '提示', {}).then(() => {
                    ...
                    this.post_url(url, param, "修改角色下权限失败！", null).then(function (res) {
                        that.addLoading = false;
                        console.info(res);
                        if (res.headers.code == Variable_global.errorCode.SUCCESS) {
