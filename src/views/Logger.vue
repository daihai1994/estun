    ...
    <div>
        ...
        <el-col :span="24" style="padding-bottom: 0;">
            <el-form :inline="true" :model="filters">
                <el-form-item prop="operator">
                    <el-input v-model="filters.operator" placeholder="操作人" prefix-icon="el-icon-search" @keyup.enter.native="btnSearch()"></el-input>
                </el-form-item>
                <el-form-item prop="ip">
                    <el-input v-model="filters.ip" placeholder="IP地址" prefix-icon="el-icon-search" @keyup.enter.native="btnSearch()"></el-input>
                </el-form-item>
                <el-form-item prop="type">
                    <el-select v-model="filters.type" placeholder="请选择" @change="btnSearch">
                        <el-option
                ...
                <el-form-item prop="time">
                    <el-date-picker v-model="filters.times" type="daterange" range-separator="至"
        ...
        <el-col :span="24">
            <el-pagination layout="total, sizes, prev, pager, next, jumper"
                           ...
                           :page-sizes="[10, 20, 50, 100]" :page-size="pageSize" :total="tableLength"
                           style="float:right;">
            </el-pagination>
        </el-col>
    </div>
    ...
    export default {
        ...
        methods: {
            ...
            search: function () {
                ...
                this.post_url(url, param, "查询日志失败！", null).then(function (res) {
