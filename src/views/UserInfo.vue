<template>
    <div>
        <el-col :span="18" style="padding-bottom: 0;">
            ...
            <el-col :span="24" style="padding-bottom: 0;">
                <el-form :inline="true" :model="filters" class="user_form">
                    <el-form-item prop="name">
                        <el-input v-model="filters.name" placeholder="姓名" prefix-icon="el-icon-search" @keyup.enter.native="btnSearch()"></el-input>
                    </el-form-item>
                    <el-form-item prop="phone">
                        <el-input v-model="filters.username" placeholder="手机号" prefix-icon="el-icon-search" @keyup.enter.native="btnSearch()"></el-input>
                    </el-form-item>
            ...
            <!--新增界面-->
            <el-dialog v-dialogDrag title="新增人员" :visible.sync="addFormVisible" :close-on-click-modal="false">
                <el-form :model="addForm" label-width="100px" :rules="addFormRules" ref="addForm">
                    <el-form-item label="姓名" prop="name">
                        <el-input v-model="addForm.name" auto-complete="off"></el-input>
                    </el-form-item>
                    <el-form-item label="手机号" prop="username">
                        <el-input v-model="addForm.username" auto-complete="off" readonly
                                  onfocus="this.removeAttribute('readonly');"></el-input>
                    </el-form-item>
                    <el-form-item label="邮箱" prop="mail">
                        <el-input v-model="addForm.mail" auto-complete="off" readonly
                                  onfocus="this.removeAttribute('readonly');"></el-input>
                    </el-form-item>
                    <el-form-item label="密码" prop="password">
                        <el-input v-model="addForm.password" auto-complete="off" show-password readonly
                                  onfocus="this.removeAttribute('readonly');"></el-input>
                    </el-form-item>
                </el-form>
            ...
            <!--编辑界面-->
            <el-dialog v-dialogDrag title="编辑人员" :visible.sync="editFormVisible" :close-on-click-modal="false">
                <el-form :model="editForm" label-width="100px" :rules="editFormRules" ref="editForm">
                    ...
                    <el-form-item label="邮箱" prop="mail">
                        <el-input v-model="editForm.mail" auto-complete="off" readonly
                                  onfocus="this.removeAttribute('readonly');"></el-input>
                    </el-form-item>
                </el-form>
                <div slot="footer" class="dialog-footer">
            ...
            search: function () {
                ...
                that.post_url(url, param, "角色查询失败！", null).then(function (res) {
                    ...
                    if (res.headers.code == Variable_global.errorCode.SUCCESS) {
                        ...
                        that.post_url(url, param, "查询失败！", null).then(function (res) {
