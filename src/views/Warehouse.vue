<template>
    <div>
        <el-col :span="18" style="padding-bottom: 0;">
            <!--工具条-->
            <el-col :span="24" style="padding-bottom: 0;">
                <el-form :inline="true" :model="filters">
                    <el-form-item prop="name">
                        <el-input v-model="filters.name" placeholder="仓库名称" prefix-icon="el-icon-search" @keyup.enter.native="btnSearch()"></el-input>
                    </el-form-item>
                    <el-form-item prop="phone">
                        <el-input v-model="filters.address" placeholder="仓库地址" prefix-icon="el-icon-search" @keyup.enter.native="btnSearch()"></el-input>
                    </el-form-item>
                    <el-form-item prop="effective" style="margin-right: 10px">
                        <el-select v-model="filters.effective" placeholder="请选择" style="width: 100px" @change="typeChange">
                            <el-option
            ...
            <el-col :span="24">
                <el-pagination layout="total, sizes, prev, pager, next, jumper" @size-change="handleSizeChange"
                               ...
                               :page-size="pageSize" :total="tableLength" style="float:right;">
                </el-pagination>
            </el-col>
        </el-col>
        <el-col :span="6" style="padding-bottom: 0;padding-left: 10px">
            <!--工具条-->
            <el-col :span="24" style="padding-bottom: 0;height: 62px">
                <el-row>
                    <el-button type="primary" :disabled="disabledOperation" @click="updateWareHouseManager">修改仓管员
                    </el-button>
                </el-row>
            </el-col>
            <el-table
        ...
        <!--新增界面-->
        <el-dialog title="新增仓库" :visible.sync="addFormVisible" :close-on-click-modal="false">
        ...
        <!--编辑界面-->
        <el-dialog title="编辑仓库" :visible.sync="editFormVisible" :close-on-click-modal="false">
            <el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
                <el-form-item label="仓库名称" prop="name">
                    <el-input v-model="editForm.name" auto-complete="off"></el-input>
                </el-form-item>
                <el-form-item label="仓库地址" prop="username">
                    <el-input v-model="editForm.address" auto-complete="off" readonly
    ...
    export default {
        ...
        methods: {
            ...
            searchWareHouseOperation: function () {
                ...
                this.post_url(url, param, "查询失败！", null).then(function (res) {
                ...
                this.$refs.editForm.validate((valid) => {
                    if (valid) {
                        this.$confirm('确认提交吗？', '提示', {}).then(() => {
                            ...
                            this.post_url(url, param, "修改失败！", null).then(function (res) {
                ...
                this.$refs.addForm.validate((valid) => {
                    if (valid) {
                        this.$confirm('确认提交吗？', '提示', {}).then(() => {
                            ...
                            this.post_url(url, param, "新增失败！", null).then(function (res) {
            ...
            updateWareHouseManager: function () {
                ...
                this.$confirm('确认提交吗？', '提示', {}).then(() => {
                    ...
                    this.post_url(url, param, "修改仓库管理员失败！", null).then(function (res) {
                        that.addLoading = false;
                        console.info(res);
                        if (res.headers.code == Variable_global.errorCode.SUCCESS) {
